                    ...
                    for gv in grads_accum_and_vars:
                        ...
                        if 'kernel' in name:
                            if 'predictions' in name:
                                with open('error_'+mode+'_all.csv', 'a', newline='') as csv_file:
                                    csv_writer = csv.writer(csv_file)

                                    if csv_file.tell() == 0:
                                        csv_writer.writerow(header_err)
                                        csv_writer.writerow(epoch1)
                                with open('error_'+mode+'_cer.csv', 'a', newline='') as csv_file:
                                    csv_writer = csv.writer(csv_file)
                            ...
                            with open('grad_'+mode+'_all.csv','a', newline='') as csv_file:
                                csv_writer = csv.writer(csv_file)

                                if csv_file.tell() == 0:
                                    csv_writer.writerow(header)
                                    csv_writer.writerow(epoch1)
                            with open('grad_'+mode+'_cer.csv', 'a', newline='') as csv_file:
                                csv_writer = csv.writer(csv_file)
